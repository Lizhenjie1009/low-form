...
import { advancedFields, customFields } from './widgetsConfig'
import { containers, basicFields } from '@/packages/form-designer/components'
...
interface ConfigState {
  ...
  selectedId: any
  selectedWidget: any
  selectedWidgetName: any //选中组件名称（唯一）
  formWidget: any //表单设计容器
  cssClassList: any //自定义样式列表
  historyData: any
}
const defaultFormConfig = deepClone(getDefaultFormConfig())
const VARIANT_FORM_VERSION = '3.3.0'
